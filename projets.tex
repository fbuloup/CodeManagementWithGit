...
\begin{frame}
\center{\includegraphics[scale=0.475]{images/devis.png}
...
\begin{frame}
\centering
        \includegraphics[scale=0.28]{images/Step1Resume.png}
        \captionof{figure}{Résumé étape 1}
\end{frame}


\subsection{Étapes 2 \& 3}
\begin{frame}
