...
\begin{frame}
   ...
   \item Github et GitLab sont deux exemples de solutions complètes
    ...
    \centering
        \begin{tabular}{c c}
            \includegraphics[scale=0.15]{images/github.png} & \includegraphics[scale=0.1]{images/gitlab.png} \\
    ...
    \begin{block}{Git n'est pas un espace de stockage de fichiers type Dropbox}
        \begin{itemize}
            ...
            \item Pas de gestion optimale des fichiers volumineux et/ou binaires
        \end{itemize}
    \end{block}
\end{frame}
...
\item Fichiers binaires (e.g. images)
\item Fichiers de données
