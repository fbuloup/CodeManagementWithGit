...
\section{Annexes}
\subsection{Console, Terminal : Command Line Interface (CLI)}
\begin{frame}[containsverbatim]

\begin{block}{Console, Terminal (Win, Linux, OSX) - Commandes de base 1/2}
\begin{lstlisting}
...
\begin{block}{Console, Terminal (Win, Linux, OSX) - Commandes de base 2/2}
\begin{lstlisting}
# Set "Some text" in fileName (Delete, Create before)
$ echo Some text > fileName
# Append "Some text" in fileName (Create before)
$ echo Some text >> fileName
$ vi fileName      # Edit fileName
$ notepad fileName # Idem (Win)
$ ls               # list current directory content
$ dir              # Idem (Win)
$ ls -la           # Full info and all
\end{lstlisting}
\end{block}
\end{frame}
...
\centering
\includegraphics[scale=0.1]{images/shortsDeliciousInsights.png} \\
\textcolor{blue}{\textbf{\underline{\href{https://www.youtube.com/@DeliciousInsights/shorts}{Shorts Git (sur Delicious Insights)}}}}
\end{minipage}\hfill
\begin{minipage}{0.5\linewidth}
\centering
\includegraphics[scale=0.3]{images/HEAD.png} \\
\textcolor{blue}{\textbf{\underline{\href{https://stackoverflow.com/questions/2221658/whats-the-difference-between-head-and-head-in-git}{les formes de HEAD expliquées sur StackOverflow}}}}
\end{minipage}
\vfill
\begin{minipage}{0.5\linewidth}
\centering
\includegraphics[scale=0.3]{images/gitIgnore.jpg} \\
\textcolor{blue}{\textbf{\underline{\href{https://www.youtube.com/watch?v=gkzBzBomYyI}{"Ignorer des fichiers" (sur Delicious Insights)}}}}
\end{minipage}\hfill
\begin{minipage}{0.5\linewidth}
\centering
\includegraphics[scale=0.1]{images/remise.png} \\
