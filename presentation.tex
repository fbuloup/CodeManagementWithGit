...
\begin{frame}
\begin{exampleblock}{Exercice \Roman{exampleBlockCounter} - Étapes 1, 2, 3 \& 4 du projet}\stepcounter{exampleBlockCounter} 
\begin{enumerate}
...
\begin{enumerate}
    ...
    \item Continuer pour archiver l'étape 2, 3 \& 4 du projet 
\end{enumerate}
...
\begin{exampleblock}{Exercice \Roman{exampleBlockCounter} - Création d'une branche et étape 5 du projet}
\begin{enumerate}
    \item Créer une branche nommée "step5"
    \item Implémenter cette étape dans cette branche
\end{enumerate}
\end{exampleblock}
\justifying
\textcolor{red}{\textbf{Interruption inattendue : votre boss vous dit de changer les caractères 'r' et 's' par 'd' et 'a' pour le démarrage et l'arrêt d'un essai. Ce changement doit être opérationnel dès que possible ! (vous pourriez imaginer autre chose de plus utile !)}}
\begin{exampleblock}{Exercice \Roman{exampleBlockCounter} - Création d'une branche et étape 5 du projet}\stepcounter{exampleBlockCounter}
\begin{enumerate}
	\setcounter{enumi}{2}
    \item Vous retournez dans la branche main et faites les changements
    \item Vous archivez ces changements et les utilisez en production !
